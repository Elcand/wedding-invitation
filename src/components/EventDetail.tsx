...
const CALENDAR_URL = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent("Jonathan & Georgia — Wedding Celebration")}&dates=20260830T020000Z/20260830T090000Z&details=${encodeURIComponent("Bergabunglah bersama kami merayakan cinta Jonathan dan Georgia.")}&location=${encodeURIComponent(`${VENUE}, ${VENUE_ADDRESS}`)}`;
    ...
    <section id="details" data-background-video="2" className="relative py-24 sm:py-32 lg:py-40">
      <div className="section-shell">
        <div className="flex flex-col justify-between gap-8 border-b border-[#f5f2eb]/15 pb-10 sm:flex-row sm:items-end">
          <div>
            <p className="eyebrow">02 / The celebration</p>
            <h2 className="mt-5 max-w-2xl font-display text-5xl leading-[0.9] tracking-[-0.04em] sm:text-7xl">
              Save the date,
              <br />
              <span className="italic text-[#e0c79c]">join the joy.</span>
            </h2>
          </div>
          <p className="max-w-xs text-sm leading-6 text-[#f5f2eb]/55 sm:text-right">
            Kami menanti Anda untuk menjadi bagian dari hari yang penuh hangat, tawa, dan cerita baru.
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-stretch">
          <div className="glass-panel flex flex-col justify-between p-6 sm:p-10">
            <div>
              <div className="flex items-center justify-between gap-5">
                <div>
                  <p className="text-[0.62rem] font-semibold uppercase tracking-[0.24em] text-[#c9aa7a]">The countdown</p>
                  <p className="mt-2 font-display text-2xl italic text-[#f5f2eb]/90">Menuju hari kami</p>
                </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-1">
            <article className="border border-[#f5f2eb]/15 p-6 sm:p-8">
              ...
              <h3 className="mt-8 font-display text-3xl">Holy Matrimony</h3>
              <p className="mt-2 text-sm text-[#f5f2eb]/55">Sabtu, 30 Agustus 2026</p>
            ...
            <article className="border border-[#f5f2eb]/15 p-6 sm:p-8">
              ...
              <h3 className="mt-8 font-display text-3xl">Wedding Reception</h3>
              <p className="mt-2 text-sm text-[#f5f2eb]/55">Sabtu, 30 Agustus 2026</p>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="grid gap-px bg-[#f5f2eb]/15 sm:grid-cols-3">
            <article className="bg-[#20211d] p-6 sm:p-7">
              ...
              <p className="mt-7 text-[0.6rem] font-semibold uppercase tracking-[0.22em] text-[#c9aa7a]">Attire guide</p>
              <h3 className="mt-3 font-display text-2xl">Garden formal</h3>
              <div className="mt-6 flex gap-2" aria-label="Pilihan warna pakaian">
              ...
              <p className="mt-4 text-xs leading-5 text-[#f5f2eb]/50">Earth tones pilihan kami untuk hari yang hangat.</p>
            </article>
            <article className="bg-[#20211d] p-6 sm:p-7">
              <Gift size={19} className="text-[#c9aa7a]" strokeWidth={1.4} />
              <p className="mt-7 text-[0.6rem] font-semibold uppercase tracking-[0.22em] text-[#c9aa7a]">Wedding gift</p>
              <h3 className="mt-3 font-display text-2xl">Kirim hadiah</h3>
              <p className="mt-2 text-xs leading-5 text-[#f5f2eb]/50">BCA · a.n. Jonathan &amp; Georgia</p>
              <button
                type="button"
              ...
              >
                ...
                {copied ? "Nomor tersalin" : BANK_NUMBER}
              </button>
            </article>
            <article className="bg-[#20211d] p-6 sm:p-7">
              <Radio size={19} className="text-[#c9aa7a]" strokeWidth={1.4} />
              <p className="mt-7 text-[0.6rem] font-semibold uppercase tracking-[0.22em] text-[#c9aa7a]">Live stream</p>
              <h3 className="mt-3 font-display text-2xl">Join remotely</h3>
              <p className="mt-2 text-xs leading-5 text-[#f5f2eb]/50">Tautan broadcast akan dibagikan menjelang hari-H.</p>
